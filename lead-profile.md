...
- Оценивает работу своих сотрудников. Проводит для них [performance review](./goal-setting.md#performance-review). Обсуждает поставленную оценку на калибровках. Даёт обратную связь по итогам performance review.
